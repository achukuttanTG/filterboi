...
@trojanz.on_message(filters.command('start') filters.group & filters.private)
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Lᴇᴛs Rᴏʟʟ ✨", url="https://t.me/ReqUpdateBot?start")
                ]
            ]
        ),
...
@trojanz.on_message(filters.command('help') filters.group & filters.private)
...
@trojanz.on_message(filters.command('about') filters.group & filters.private)
            ...
            [
                [
                    InlineKeyboardButton(
                        "sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url="https://t.me/dkbotxchats")
                ],
                [
